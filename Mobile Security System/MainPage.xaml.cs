...
namespace Mobile_Security_System
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        public MainPage()
        {
            ...
            timer_.Interval = TimeSpan.FromMilliseconds(250);
            timer_.Tick += (o, arg) => ScanPreviewBuffer();
            timer_.Start();
        }
        ...
        private void ScanPreviewBuffer()
        {
            if (cameraInitialized_)
            {
                ...
                {
                    firstImageToCompare_ = new Image(ARGBPx, (int)cameraRes_.Width, (int)cameraRes_.Height);
                }
                // Do the comparison and detect the motion
                else
                {
                    Image newImage = new Image(ARGBPx, (int)cameraRes_.Width, (int)cameraRes_.Height);
